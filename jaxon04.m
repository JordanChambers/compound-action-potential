function mjp = jaxon04(jfac1b, jfac2b, jfac3b, jfac4b, jfac5b, jfac6b, jfacDis, jfacpas)
...
%%%       - jfacpas - describes the periaxonal space
    ...
    jfac1 = jfac1b + 0.25*randn(1,jreps);%node diameter and internode diameter %% 0.61 + 0.37 (using 0.15)
    ...
    jfac5 = jfac5b + 0.1*randn(1,jreps);%g-ratio %% 0.7025 + 0.0356; 0.7266 + 0.0240
    jfac7 = 1 + 0.1*randn(1,jreps);
    jfacpasv = jfacpas + 0.25*randn(1,jreps);
