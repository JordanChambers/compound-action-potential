function mjp = jaxon03gr(jfac1b, jfac2b, jfac3b, jfac4b, jfac5b, jfac6b)
...
%%%       - jfac6b - reduce the number of lamellae by this many
    ...
    jfac1 = jfac1b + 0*randn(1,jreps);%node diameter and internode diameter %% 0.61 + 0.37 (using 0.15)
