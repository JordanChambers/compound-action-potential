function par = jCreateAxon03CorpusCallosum(jtm, jfac1, jfac2, jfac3, jfac4, jfac5, jaxonlen, jfac6, jfacps)
% Based on Bakiri2011CorpusCallosum
...
par.stim.amp.value = 10;%6+(5*(jfac4-1));%7;
...
% Node geometry
% Node diameter.
par.node.geo.diam.value.ref = 0.6*jfac1;%0.65*jfac1;%0.36*jfac1;
...
par.intn.geo.diam.value.ref = 0.72*jfac1;%0.36*jfac1;
...
par.myel.geo.peri.value.ref = jfacps*5.5;
